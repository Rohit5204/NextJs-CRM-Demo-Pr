...
function BasicExample() {
    ...
    const postData = () => {
        console.log({
            masterName: masterName, inputText: inputText,
        })
        ...
        <div className='pl-5 pr-5'>
            ...
            <Form>
                <Row className="mb-3">
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Select  onChange={(e) => setMasterName(e.target.value)} value={masterName} aria-label="Platform Name">
                    ...
                    <Col>
                        <Form.Group >
                            ...
                            <Form.Control onChange={(e) => setInputText(e.target.value)} value={inputText} placeholder="Enter the Platform" />
                        </Form.Group>
                    </Col>
                </Row>
                {/* <Row className="mb-3">
                ...
                <Button onClick={handleSubmit} variant="primary" type="submit" className='btn btn-primary mb-2'>
                    ...
                    <Button onClick={Edit} variant="primary" type="submit" className='btn btn-primary mb-2'>
                        Update
                    </Button>
                </div>
            </Form>
                            ...
                            {APIData.map((i) => {
                                return (
                                    <tr key={i.id}>
                                        ...
                                        <td>
                                             <button onClick={event => updateData(event, i)} className="btn btn-info">Update </button> 
